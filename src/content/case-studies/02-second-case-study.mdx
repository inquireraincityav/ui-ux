...
<CsSection label="Iterative Design">
  <CsStatement>
    The build was iterative - prototyping in Figma, building in Wix, and incorporating client feedback at every stage
  </CsStatement>
...
<CsSection label="Reflections">
  ...
  **Performance is part of the design.** The client's earlier gallery attempts had loading issues. Solving that on the Wix build wasn't a dev task bolted on at the end - it was a design constraint from day one that shaped how the gallery was structured.
